...
AdsResponseData adsResponseDataFromJson(String str) => AdsResponseData.fromJson(json.decode(str));

String adsResponseDataToJson(AdsResponseData data) => json.encode(data.toJson());
...
class AdsResponseData {
  ...
  factory AdsResponseData.fromJson(Map<String, dynamic> json) => AdsResponseData(
    status: json["Status"],
