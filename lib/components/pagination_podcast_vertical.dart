...
class PaginationPodcastsVertical extends StatefulWidget {
  final String apiEndPoint;
  final String headerTitle;
  final String? category;

  const PaginationPodcastsVertical(
      {Key? key,
  ...
  @override
  State<PaginationPodcastsVertical> createState() =>
      _PaginationPodcastsVerticalState();
}

class _PaginationPodcastsVerticalState
    extends State<PaginationPodcastsVertical> {
  int _page = 0;
